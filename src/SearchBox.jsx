...
const SearchBox = ({ setSearchResults }) => {
    ...
    return (
        <div className="search m-auto w-3/4 max-w-xl bg-gray-200 rounded-lg flex">
            ...
            <input id='searchBox' autoComplete="off" onBlur={onBlurTextBox} type="text" onChange={runSearch} className="text-cent pt-2.5 pb-1.5 px-2 mr-3 bg-gray-200 w-full focus:outline-none focus:ring-transparent" name="search" placeholder="search for a video" />
